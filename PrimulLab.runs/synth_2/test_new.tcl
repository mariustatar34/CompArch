...
synth_design -top test_new -part xc7a100tcsg324-2L


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef test_new.dcp
create_report "synth_2_synth_report_utilization_0" "report_utilization -file test_new_utilization_synth.rpt -pb test_new_utilization_synth.pb"
